  ...
  return (
    <>
      ...
      <div style={{ background: '#fff', borderBottom: '1px solid #e5e5ee' }}>
        <div style={{ maxWidth: 720, margin: '0 auto', padding: '44px 24px 36px' }}>
      ...
      {/* Market stats */}
      {mktData && <section aria-labelledby="market-heading" style={{ maxWidth: 900, margin: '0 auto', padding: '20px 24px 0' }}><div className="s">
