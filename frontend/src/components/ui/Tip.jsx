...
export default function Tip({ active, payload, label, fmt, unit }) {
  if (!active || !payload || !payload.length) return null;
  return (
    <div style={{ background: `${T.text}f0`, padding: '10px 14px', borderRadius: T.r, border: `1px solid ${T.textFaint}`, boxShadow: '0 4px 20px rgba(0,0,0,0.06)' }}>
