...
export default function MarketOverview({ data }) {
  ...
  return (
    <div style={{ display: 'grid', gap: 16 }}>
      ...
      <div className="g2">
        <Card>
          <SectionHeader title="Sale Market Snapshot" sub="Key metrics at a glance — click Sales tab for deep dive" />
        ...
        <Card>
          <SectionHeader title="Rental Market Snapshot" sub="Key metrics at a glance — click Rental tab for deep dive" />
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
      ...
      <div className="g2">
        <Card><SectionHeader title="Market Segments" sub="Volume and PSF by segment." />
        ...
        <Card><SectionHeader title="Most Active Projects" sub="High-volume projects — easier to buy and exit." />
