...
export default function CompareTab({ proj, cmpPool, cmpSelected, setCmpSelected, mktData, nearbyProjects = [] }) {
  ...
  const allProjects = useMemo(() => {
    ...
    // Self
    if (map[proj]) map[proj].rel = 'self';
    return map;
  }, [cmpPool, nearbyProjects, proj]);
