...
export default function RecordsTab({ projInfo, projData }) {
  ...
  return (
    <div style={{ display: 'grid', gap: 16 }}>
      ...
      <SectionHeader icon="🏠" title="Rental Contracts" sub={`${filteredRentTx.length} of ${(projData?.projRentTx || []).length} rental records. URA rental data is aggregated by quarter.`} />
      <Card>
