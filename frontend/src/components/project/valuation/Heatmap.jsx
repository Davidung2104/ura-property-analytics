/**
 * Heatmap.jsx — Floor × Year heatmap with PSF/Price/Vol toggle + YoY diff mode
 * Extracted from ValuationTab lines 696–785
 */
import { useState, useMemo } from 'react';
import { T, pctChgColor, totalPctColor } from '../../../constants';
import { Card, SectionHeader, NoteText } from '../../ui';

export default function Heatmap({ projData, projSizes, filteredTxs, filteredHm }) {
