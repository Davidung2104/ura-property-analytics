          ...
          <div style={{ position: 'sticky', top: 0, zIndex: 20, padding: '8px 28px', background: T.pageBg || '#f8fafc', borderBottom: '1px solid #e2e8f0' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, flexWrap: 'wrap', background: '#fff', border: `1px solid ${T.border}`, borderRadius: 8, padding: '10px 16px', boxShadow: '0 2px 8px rgba(0,0,0,0.08)' }}>
              ...
              {bedOptions.length >= 2 && <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                <span style={{ color: '#64748b', fontSize: 12, fontWeight: 700, letterSpacing: 0.5 }}>🛏️</span>
              ...
              {txYears.length > 1 && <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                <span style={{ color: '#64748b', fontSize: 12, fontWeight: 700, letterSpacing: 0.5 }}>📅</span>
                <select value={effectiveYearFrom} onChange={e => setYearFrom(e.target.value)} style={{ border: '1px solid #e2e8f0', borderRadius: 5, padding: '3px 8px', fontSize: 12, color: '#1e293b', background: yearFrom ? '#f5f3ff' : '#fff', fontFamily: T.mono }}>
                  {txYears.filter(y => y <= effectiveYearTo).map(y => <option key={y} value={y}>{y}{y === currentYear ? '*' : ''}</option>)}
                </select>
                <span style={{ color: '#94a3b8', fontSize: 11 }}>→</span>
                <select value={effectiveYearTo} onChange={e => setYearTo(e.target.value)} style={{ border: '1px solid #e2e8f0', borderRadius: 5, padding: '3px 8px', fontSize: 12, color: '#1e293b', background: yearTo ? '#f5f3ff' : '#fff', fontFamily: T.mono }}>
              ...
              {saleTypes.length > 1 && <>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                  <span style={{ color: '#64748b', fontSize: 12, fontWeight: 700, letterSpacing: 0.5 }}>🏷️</span>
                  <select value={saleTypeFilter} onChange={e => setSaleTypeFilter(e.target.value)} style={{ border: '1px solid #e2e8f0', borderRadius: 5, padding: '3px 8px', fontSize: 12, color: '#1e293b', background: saleTypeFilter !== 'all' ? '#f5f3ff' : '#fff' }}>
              ...
              {tenureTypes.length > 1 && <>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                  <span style={{ color: '#64748b', fontSize: 12, fontWeight: 700, letterSpacing: 0.5 }}>📜</span>
                  <select value={tenureFilter} onChange={e => setTenureFilter(e.target.value)} style={{ border: '1px solid #e2e8f0', borderRadius: 5, padding: '3px 8px', fontSize: 12, color: '#1e293b', background: tenureFilter !== 'all' ? '#f5f3ff' : '#fff' }}>
              ...
              {floorBands.length > 1 && <>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                  <span style={{ color: '#64748b', fontSize: 12, fontWeight: 700, letterSpacing: 0.5 }}>🏗️</span>
                  <select value={floorFilter} onChange={e => setFloorFilter(e.target.value)} style={{ border: '1px solid #e2e8f0', borderRadius: 5, padding: '3px 8px', fontSize: 12, color: '#1e293b', background: floorFilter !== 'all' ? '#f5f3ff' : '#fff' }}>
