...
/**
 * Force backend to re-fetch from URA API.
 * Requires ADMIN_KEY — call via CLI/cron, not from browser:
 *   curl -X POST https://your-domain.com/api/refresh?key=YOUR_ADMIN_KEY
 * Frontend uses refreshDashboard() to get fresh data from cache instead.
 */
