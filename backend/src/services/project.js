 ...
 */
import { fetchBatch } from './ura-client.js';
import { parseDate, parseFloor, avg, med, getYield } from './helpers.js';
import { inferBedrooms } from './bedroom.js';
...
function _buildNearbyProjects(projectName, dist, projStreet) {
  ...
  // Pre-build per-project per-bedroom per-year PSF
